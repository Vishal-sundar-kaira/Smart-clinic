...
router.post('/login',[//here we are sending our necessity like password should be of this lenghth only.
  ...
  try{
    ...
    const passwordcompare=await bcrypt.compare(req.body.password, user.password)//we use bcrypt compare because it compare also the salt added into your password
